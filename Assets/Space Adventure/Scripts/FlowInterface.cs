...
namespace StarDrop {
    public class FlowInterface : MonoBehaviour {
        ...
        private void Start() {
            ...
            Login(() => { Debug.Log("Login successful!"); }, () => { Debug.Log("Login failed!"); });
        }
        ...
        /// </summary>
        public static async Task<int> ExecuteGetTokens(string userAddress) {
            ...
            return Int32.Parse(responseVal.Value);
        }
