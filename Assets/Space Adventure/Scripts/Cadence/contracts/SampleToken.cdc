...
pub contract SampleToken {
    ...
    pub resource VaultMinter {
        ...
        pub fun mintTokens(amount: UFix64, recipient: Capability<&AnyResource{Receiver}>) {
            ...
            SampleToken.totalSupply = SampleToken.totalSupply + UFix64(amount)
    ...
    init() {
        ...
        self.VaultPublicPath = /public/SampleTokenVault
        self.MinterStoragePath = /storage/SampleTokenMinter
