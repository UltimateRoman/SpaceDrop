...
transaction(
    ...
    let minter: &SpaceDropNFT.NFTMinter
    ...
    prepare(signer: AuthAccount) {
        self.mintingIDBefore = SpaceDropNFT.totalSupply

        // borrow a reference to the NFTMinter resource in storage
        self.minter = signer.borrow<&SpaceDropNFT.NFTMinter>(from: SpaceDropNFT.MinterStoragePath)
    ...
    post {
        ...
        SpaceDropNFT.totalSupply == self.mintingIDBefore + 1: "The total supply should have been increased by 1"
    }
}
